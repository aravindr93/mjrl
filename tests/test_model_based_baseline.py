...
if __name__ == '__main__':
    ...
    eval_paths = sample_paths(args.num_eval_trajs, args.env_name, data_policy, eval_mode=True, base_seed=args.seed+1)
    ...
    def test(H):
        ...
        for path in eval_paths:
            ...
            values_model = baseline.value(obs, time, stop=False)
