...
class GLP:
    def __init__(self, env_spec,
        ...
        self.model.add_module('lin_layer', nn.Linear(self.n, self.m))
        # make weights small
        for param in list(self.model.parameters()):
           param.data = (0.1/(self.n + self.m)) * param.data
        ...
        self.old_model.add_module('old_lin_layer', nn.Linear(self.n, self.m))
